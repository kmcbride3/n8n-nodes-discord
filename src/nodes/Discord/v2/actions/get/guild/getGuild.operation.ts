...
import { executeV2OperationWithClient, fetchGuild, simplifyGuild, updateDisplayOptions } from '../../../helpers'
  ...
  [
    {
      ...
      required: true,
      default: '',
      description: 'The ID of the guild to fetch',
    },
    {
...
interface IGET_GetGuildCredentials extends IV2DiscordCredentials {
  client: Client
}

export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
  return executeV2OperationWithClient<IGET_GetGuildCredentials>(this, {
    ...
    operation: async (ctx, { client }, itemIndex) => {
      ...
      return {
        json: (simplify ? simplifyGuild(guild) : guild.toJSON()) as IDataObject,
      }
    },
