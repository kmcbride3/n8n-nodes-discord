...
import { executeV2OperationWithClient, fetchChannel, simplifyChannel, updateDisplayOptions } from '../../../helpers'
  ...
  [
    {
      ...
      required: true,
      default: '',
      description: 'The ID of the channel to fetch',
    },
    {
...
interface IGET_GetChannelCredentials extends IV2DiscordCredentials {
  client: Client
}

export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
  return executeV2OperationWithClient<IGET_GetChannelCredentials>(this, {
    ...
    operation: async (ctx, { client }, itemIndex) => {
      ...
      return {
        json: (simplify ? simplifyChannel(channel) : channel.toJSON()) as IDataObject,
      }
    },
