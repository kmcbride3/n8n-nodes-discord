...
interface IGET_GetMemberCredentials extends IV2DiscordCredentials {
  client: Client
}

export async function execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
  return executeV2OperationWithClient<IGET_GetMemberCredentials>(this, {
    ...
    operation: async (ctx, { client }, itemIndex) => {
      ...
      return {
        json: (simplify ? simplifyMember(member) : member.toJSON()) as IDataObject,
      }
    },
